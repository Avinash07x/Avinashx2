            ...
            <li key={item.name} className="relative group">
              ...
              >
                ...
                <img
                  src={item.icon}
                  alt={item.name}
                  className="w-10 h-10 p-2 group-hover:opacity-0 group-hover:scale-50 transition-all duration-300"
                />
              </HashLink>
            </li>
          ))}
            ...
            {menuItems.map((item) => (
              <li key={item.name}>
                <HashLink
                  ...
                  className="flex items-center gap-4 px-4 py-3 text-white font-medium rounded-lg hover:bg-gray-800 transition-all duration-300"
                >
