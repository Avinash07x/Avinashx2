      ...
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          <path
            ...
            .098-2.65 0 0 .84-.27 2.75 1.026A9.564 9.564 
    ...
    },
    {
      ...
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          -1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 
          ...
          24 23.227 24 22.271V1.729C24 .774 
      ...
      <div className="max-w-6xl mx-auto px-5 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="space-y-4">
            <h3 className="text-xl font-bold text-white">Avinash Sharma</h3>
            <p className="text-gray-400 text-sm leading-relaxed">
              Full Stack Developer passionate about creating elegant solutions
              to complex problems. Building innovative web applications with
              modern technologies.
            </p>
          </div>
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <p className="text-gray-500 text-sm">
              &copy; {currentYear} Avinash Sharma. All rights reserved.
            </p>
